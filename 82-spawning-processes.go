...
func learn_spawning_processes() {
	...
	*/
	...
	/*
		...
		return *exec.Error if there was a problem executing the command
		(e.g. wrong path), and

		*exec.ExitError if the command ran but
	...
	*/
	...
	/*
		...
		but you could use the usual if err != nil
